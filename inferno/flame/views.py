...
def adminsetting(request):
    return render(request, 'flame/Admin_Setting.html')

def adminsecurity(request):
    return render(request, 'flame/Admin_security.html')

def adminnoti(request):
    return render(request, 'flame/Admin_Noti.html')

def admindash(request):
    return render(request, 'flame/User_AdminDash.html')
...
def admindashboard(request):
    return render(request, 'flame/dashboardpage.html')
