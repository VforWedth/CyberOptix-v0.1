...
from flame.models import Product,ProductReview, ReviewReport,CartOrder, EmailTemplate, SocialMediaPost, Shop, MyanmarState, MyanmarCity, MyanmarTownship, ShippingRate
