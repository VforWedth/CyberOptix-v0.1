# CyberOptix LaptopMart Myanmar v0.1 - Bilingual Feature
...
This branch includes **Bilingual Support (EN/MY)** with chatbot functionality.
...
* **🆕 Bilingual Support**: English and Burmese language switching
...
* **Translation**: Django Parler, Rosetta
* **AI Chatbot**: Custom chatbot integration
...
* Switch between English and Burmese languages using the language toggle.
* Use the chatbot for customer support.
